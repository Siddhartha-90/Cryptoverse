...
const CryptoDetails = () => {
  ...
  const {data:coinHistory}=useGetCryptoDetailsQuery({coinuuid, timestamp})
  ...
  const matchedStats = stats.filter(item => genericStats.includes(item));
  ...
  return (
    <Col className='coin-detail-container'>
      ...
      <Select 
         ...
         {/* <LineCart coinHistory={coinHistory} currentPrice={millify(data?.data?.coin.price)} coinName={data?.data?.coin.name}/> */}
         <Col className='stats-container'>
            ...
            <Col className='other-stats-info'>
              <Col className='coin-value=statistics-heading'>
                  ...
                  <p>
                    An overview of all Cryptocurrency
                  </p>
